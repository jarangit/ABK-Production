...
module.exports = {
  siteMetadata: {
    ...
    description: `เครื่องปอกมะพร้าวครบวงจร, เครื่องขูดมะพร้าว, เครื่องคั้นกะทิ, เครื่องกะเทาะเปลือกมะพร้าว, เครื่องดึงใยมะพร้าว, เหล็กแหลม, ถุงผ้าคั้นกระทิ,ซ่อมเครื่องปอกมะพร้าวครบวงจร, ซ่อมเครื่องขูดมะพร้าว, ซ่อมเครื่องคั้นกะทิ, ซ่อมเครื่องกะเทาะเปลือกมะพร้าว, ซ่อมเครื่องดึงใยมะพร้าว, `,
    author: `@gatsbyjs`,
